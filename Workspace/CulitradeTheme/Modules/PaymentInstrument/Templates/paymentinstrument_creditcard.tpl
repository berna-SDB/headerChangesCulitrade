		...
		<div class="paymentinstrument-creditcard-container">
			<div>
				...
				<div class="paymentinstrument-creditcard-header">
					<p class="paymentinstrument-creditcard-number">{{translate 'Ending in'}}{{lastfourdigits}} </p>
				...
				<p class="paymentinstrument-creditcard-expdate">{{translate 'Expires in'}} {{expirationDate}}</p>
