<div class="global-views-format-payment-method">
	{{#if isCreditcard}}
		<div class="global-views-format-payment-method-header">
			...
			{{/if}}
			<p class="global-views-format-payment-method-number"> {{translate 'Ending in '}} {{creditCardNumberEnding}}</p>
		</div>
		<p class="global-views-format-payment-method-expdate">{{translate 'Expires in '}} {{creditCard.ccexpiredate}}</p>
