	...
	<article class="product-details-full-content" >
		...
		<section class="product-details-full-main-content">
            <div class="product-details-full-content-header">
				...
				<p>{{unitSelected.quantity}} units</p>
				<p><b>Sold by: </b>{{currentVariant.soldBy}}</p>
				
				<div class="product-details-full-rating" data-view="Global.StarRating"></div>
                <div data-view="Product.Price"></div>
				
				<div>
					<label for="unit-selector">Package options</label>
					<select name="unit-selector" id="unit-selector">
						{{#each currentVariant.options}}
							<option value="{{unitName}}" {{#ifEquals unitName ../unitSelected.unitName}}selected{{/ifEquals}}>{{price}} for a {{unitName}} ({{quantity}})</option>
						{{/each}}
					</select>
				</div>
			...
			<div class="product-details-full-main">
				{{#if isItemProperlyConfigured}}
					<form id="product-details-full-form" data-action="submit-form" method="POST">
						...
						<section style="margin-top:35px" data-view="Product.Options"></section>
				...
				<!-- 		<div data-view="Quantity.Pricing"></div> -->
						...
						{{#if isPriceEnabled}}
							...
							<section class="product-details-full-actions">
								...
								<div class="product-details-full-actions-container content-add">
                                    <div data-view="Quantity"></div>
									<div style="width: 100%;" data-view="MainActionView"></div>
		...
		<div class="product-details-full-content-related-items">
			<div data-view="Item.Variants"></div>
		</div>
