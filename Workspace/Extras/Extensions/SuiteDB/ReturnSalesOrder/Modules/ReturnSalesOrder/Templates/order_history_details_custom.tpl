...
<section>
	...
	<div class="order-history-details-row">
		...
		<!-- SUMMARY -->
		<div class="order-history-details-summary" data-view="Summary">
		</div>
		<!-- SUMMARY ENDS -->
		{{log model.options.custbody_sdb_returned}}
		{{#ifEquals model.options.custbody_sdb_returned "F"}}
		<div class="order-history-details-return-container">
      		<input type="button" value="Return Order" data-id="{{model.internalid}}" data-action="return-sales-order">
		</div>
		{{/ifEquals}}
	</div>
</section>
